...
import pdf from "../../Assets/Shoaib.pdf";
      ...
      <Container>
        ...
        <Row className="resume">
          ...
          <Col md={6} className="resume-right">
            ...
            <Resumecontent
              title="Swathi institute of tech and science "
              date="2021 - Present"
              content={[`CGPA: 7.3 (Till 8th Sem)`]}
            />
            <Resumecontent
              title="12TH BOARD [Success junior collage, Hyd]"
              date="2015 - 2017"
              content={["Precentage: 66%"]}
            />
            <Resumecontent
              title="10TH BOARD [Royal embassy high School,Hyd] "
              date="2015"
